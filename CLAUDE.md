...
- **게시물 20편 증가할 때마다** 갱신 (마지막 갱신 시점 대비)
- `content/about/index.md` 맨 아래 HTML 주석(`<!-- about-refresh-baseline: N posts / 날짜 — 다음 갱신은 N+20편 도달 시 -->`)에 마지막 갱신 시점의 게시물 수를 기록해둔다. 새 포스트를 커밋하기 전, `ls content/posts/*.md | wc -l`로 현재 개수를 확인하고 이 기준과 비교한다.
